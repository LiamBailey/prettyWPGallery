...
class prettyGallery {
    ...
    function __construct() {
        ...
        add_shortcode('gallery', array(&$this, 'gallery_shortcode_prettyPhoto'));
    }
    ...
    /**
     * The Gallery shortcode replacement.
     *
     ...
     * to fire prettyPhoto. It also hides all but the first image, leaving
     * links to form the gallery.
     *
     * @param array $attr Attributes of the shortcode.
     * @return string HTML content to display gallery.
     */
    function gallery_shortcode_prettyPhoto($attr) {
        $post = get_post();
